...
android {
    ...
    val backendUrl = System.getenv("BACKEND_URL")
        ?: project.findProperty("shotclock.apiBaseUrl") as String?
        ?: error("BACKEND_URL must be set (env var or shotclock.apiBaseUrl property).")
    val disableRegistrationRaw = (System.getenv("DISABLE_REGISTRATION")
        ?: project.findProperty("shotclock.disableRegistration") as String?
        ?: "false")
        .lowercase()
